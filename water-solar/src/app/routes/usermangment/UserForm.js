...
//drop zone
 const [files, setFiles] = useState([]);
  ...
  return (
    ...
    <Dialog open={openPopup} maxWidth="xl" onClose={handleClose}  aria-labelledby="customized-dialog-title">
        <DialogTitle  >
          <div className="row">
            ...
            <div className="col-md-6">
             <IconButton color="primary" aria-label="upload picture" component="span" className="float-right" onClose={handleClose}>
              <Clear/>
            </IconButton>
            </div>
          </div>  
