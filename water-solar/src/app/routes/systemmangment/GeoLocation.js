                    ...
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          error={
                            touched && touched.country && error && error.country
                              ? true
                              : false
                          }
                          helperText={
                      ...
                      <td>
                        <div className="pointer text-primary">
                          <IconButton
                            ...
                            aria-label="delete"
                            color="secondary"
                            onClick={() => deletGeoLocation(data.id)}
                          >
                            <DeleteIcon />
                          </IconButton>
                        </div>
                      ...
                      <td>
                        <div className="pointer text-primary">
                          <span className="d-inline-block mr-1">
                            <IconButton
                              size="small"
                              aria-label="Add Irradiation"
                              color="inherit"
                              onClick={() => {
                                setGeoLocationId(data.id);
