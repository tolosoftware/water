...
export default function DialogWaterP(props) {
  ...
  const [image, setImage] = useState({
    oldImage: "",
    filePath: "brand/pumpbrand/pump_list/",
    btnText: "Image",
  });
  let imageFile = "";
  const [dataSheet, setDataSheet] = useState({
    oldd: "",
    filePath: "brand/pumpbrand/pump_list/data_sheet/",
    btnText: "Data Sheet",
  });
  let dataSheetFile = "";
  ...
  const [diameter, setDiameter] = useState({
    oldImage: "",
    filePath: "brand/pumpbrand/pump_list/diameter/",
    btnText: "Diameter",
  });
  let diameterFile = "";
  ...
  useEffect(() => {
    ...
    setImage({
      ...image,
      oldImage: waterListObject.image ? waterListObject.image : "",
    });
    setDataSheet({
      ...dataSheet,
      oldImage: waterListObject.data_sheet ? waterListObject.data_sheet : "",
    });
    setGraph({
      ...graph,
      oldImage: waterListObject.graph ? "graph/" + waterListObject.graph : "",
    });
    setDiameter({ ...diameter, oldImage: waterListObject.diameter_file ? waterListObject.diameter_file : '' });
    ...
    >
      <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
        <DialogTitle
          ...
          className="customizedDialogWaterP"
          onClose={handleClose}
        >
              ...
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 insideFormBP">
                  <TextField
                    ...
                    name="waterListID"
                    defaultValue={
                      waterListObject?.id ? waterListObject?.id : ""
                    }
                    inputRef={register}
                  />
                  <TextField
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 insideFormBP">
                  <TextField
                    ...
                    label="Name/Model"
                    defaultValue={
                      waterListObject?.model ? waterListObject?.model : ""
                    }
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 insideFormBP inputAdornmentWrap">
                  <FormControl fullWidth>
                    <TextField
                      ...
                      defaultValue={
                        waterListObject?.outlet ? waterListObject?.outlet : ""
                      }
                      inputRef={register({
                        required: true,
                        pattern: /^[+-]?([0-9]*[.])?[0-9]+$/,
                      })}
                      error={errors.outlet && true}
                      helperText={
                        errors.outlet ? "*Please enter valid number." : ""
                      }
                    />
                  </FormControl>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 insideFormBP inputAdornmentWrap">
                  <FormControl fullWidth>
                    <TextField
                      ...
                      defaultValue={
                        waterListObject?.ampeier ? waterListObject?.ampeier : ""
                      }
                      inputRef={register({
                        required: true,
                        pattern: /^[+-]?([0-9]*[.])?[0-9]+$/,
                      })}
                      error={errors.current && true}
                      helperText={
                        errors.current ? "*Please enter valid number." : ""
                      }
                    />
                  </FormControl>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 insideFormBP inputAdornmentWrap">
                  <FormControl fullWidth>
                    <TextField
                      ...
                      error={errors.diameter && true}
                      helperText={
                        errors.diameter ? "*Please enter valid number." : ""
                      }
                    />
                  </FormControl>
                </div>
                <div className="col-xl-5 col-lg-5 col-md-5 col-12 insideFormBP powerKW-PR inputAdornmentWrap">
                  ...
                  <Slider
                    name="powerKW"
                    onChange={(event, value) => setPowerKW(value)}
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-12 insideFormBP voltage inputAdornmentWrap">
                  ...
                  <Slider
                    name="voltage"
                    onChange={(event, value) => setVoltage(value)}
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-12 insideFormBP group_radio_phase insideFormPaddingWPS p-3">
                  ...
                  >
                    <input
                      ...
                      autocomplete="off"
                      checked={
                        phase === "1Phase" || phase === undefined ? true : false
                      }
                      value="1Phase"
                    ...
                    <input
                      ...
                      id="btnradio23Phase"
                      autocomplete="off"
                      checked={phase === "3Phase" ? true : false}
                      value="3Phase"
                      onChange={(event) => setPhase(event.target.value)}
                    />
                    <label
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 insideFormBP powerHP inputAdornmentWrap">
                  ...
                  <Slider
                    name="powerHP"
                    onChange={(event, value) => setPowerHP(value)}
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 p-3">
                  <FormControl fullWidth>
                    <TextField
                      ...
                      defaultValue={
                        waterListObject?.weight ? waterListObject?.weight : ""
                      }
                      inputRef={register({
                        required: true,
                        pattern: /^[+-]?([0-9]*[.])?[0-9]+$/,
                      ...
                      helperText={
                        errors.weight ? "*Please enter valid number." : ""
                      }
                    />
                  </FormControl>
                </div>
                ...
                <div className="col-xl-8 col-lg-8 col-md-8 col-12 " style={{padding: '0px', margin: '0px'}}>
                  <div className="row" style={{padding: '0px', margin: '0px'}}>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-12 waterPumFile waterPumpListFile">
                      <DataSheetFile
                        formData={dataSheet}
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-12 waterPumFile waterPumpListFile">
                      <CustomDropzone
                        formData={graph}
                        onChange={eventhandlerGr.bind(this)}
                      />
                    </div>
                    <div className="col-xl-6 col-lg-6 col-md-6 col-12 waterPumFile waterPumpListFile">
        ...
        <DialogActions>
          <Button
            ...
            disabled={waterListObject?.id ? true : false}
