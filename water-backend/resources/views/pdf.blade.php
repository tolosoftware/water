                            ...
                            <div class='main'>
                                    ...
                                    <Table class="default-table table-unbordered table table-sm table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $project[0]->geolocation->country }},
                                                    {{ $project[0]->geolocation->city }}({{ $project[0]->geolocation->latitude }}°,
                                                    {{ $project[0]->geolocation->longtitude }}°)
                                                </td>
                                            </tr>
                                            @if ($project[0]->latitude && $project[0]->longtitude) 
                                                <tr>
                                                    <td>GPS:</td>
                                                    <td>
                                                        {{ $project[0]->latitude }}°, {{ $project[0]->longtitude }}°
                                                    </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $project[0]->daily_output }} (m³/h) @if ($project[0]->daily_output_lable != 'm³/h' && $project[0]->daily_output_lable != null)
                                                             {{ $project[0]->daily_output_changed }}
                                                            ({{ $project[0]->daily_output_lable }}) @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $project[0]->daynomic_head }}(m)</td>
                                                </tr>
                                                <tr>
                                                    <td>Pipe Friction losses:</td>
                                                    <td>
                                                        {{ ceil((int)(($project[0]->dirt_loss * $project[0]->pip_length) / 100)) }}
                                                        m (
                                                        {{ $project[0]->dirt_loss }}
                                                        %)
                                                    </td>
                                    ...
                                    <Table class="default-table table-unbordered table table-sm table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style='width: 60%;'>
                                                    {{ $solarbrand['name'] }}
                                                    {{ $solarList->solarListWithCable['power'] }}W
                                                    {{ $solarList->solarListWithCable['type'] }} crystalline
                                                    {{ $solarList->solarListWithCable['voltage'] }}V
                                                    {{ $solarList->solarListWithCable['current'] }}A
                                                </td>
                                                <td style='width: 10%;'>panel</td>
                                                <td style='width: 10%;'>
                                                    {{ $solarList->solar_quantity }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Pump</td>
                                                <td>
                                                    {{ $pupm[0]->pump_brand->name }}{{ $pupm[0]->model }}
                                                    {{ $pupm[0]->hp }}HP {{ $pupm[0]->power }}Kw
                                                    {{ $pupm[0]->voltage }}V</td>
                                                <td>pc</td>
                                                <td>1</td>
                                            </tr>
                                            <tr>
                                                <td>Controller</td>
                                                <td>
                                                    {{ $inverter->invertor_brand->name }} {{ $inverter->power }}kw
                                                    {{ $inverter->voltage }}V
                                                </td>
                                                <td>pc</td>
                                                <td>1</td>
                                            ...
                                            <tr>
                                                <td>Structure</td>
                                                <td>{{ $solarList->base }}</td>
                                                <td>set</td>
                                                <td>
                                                    {{ $solarList->panal_quantity }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Motor Cable</td>
                                                ...
                                                <td>m</td>
                                                <td>
                                                    {{ ceil((int)($project[0]->motor_cable)) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Solar Cable</td>
                                                <td>
                                                    {{ $solarList->solarListWithCable->cable->name }}
                                                </td>
                                                <td>m</td>
                                                <td>
                                                    {{ $project[0]->solar_cable }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Pipline</td>
                                ...
                                <div class="table-responsive-material mb-5 accessory-sect">
                                    <Table class="default-table table-unbordered table table-sm table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($projectAccessories as $projectAccessory)
                                                <tr key={index}>
                                                    <td style='width: 20%;'>
                                                        {{ $projectAccessory->accessoriesListWithUom->name }}
                                                    </td>
                                                    <td style='width: 60%;'>
                                                        {{ $projectAccessory->accessoriesListWithUom->model }}
                                                    </td>
                                                    <td style='width: 10%;'>
                                                        {{ $projectAccessory->accessoriesListWithUom->uom->acronym }}
                                                    </td>
                                                    <td style='width: 10%;'>
                        ...
                        <td class="report-content-cell">
                            <table style='width:100%;' class="inside-table-pump">
                                ...
                                <tr>
                                    ...
                                    <td style='width: 60%;'>
                                        @if ($pupm[0]->graph)
                                            <img src={{ URL::asset('brand/pumpbrand/pump_list/graph/' . $pupm[0]->graph) }}
                                    ...
                                    <td>
                                        @if ($pupm[0]->image)
                                            <img src={{ URL::asset('brand/pumpbrand/pump_list/' . $pupm[0]->image) }}
                                                class="img-thumbnail"
                                ...
                                <tr>
                                    <td colSpan="3">
                                        <div class='pump-diameter'>
                                            @if ($pupm[0]->diameter_file)
                                                <img src={{ URL::asset('brand/pumpbrand/pump_list/diameter/' . $pupm[0]->diameter_file) }}
                        ...
                        <td class="report-content-cell">
                            <table style='width:100%;' class="inside-table-pump">
                                ...
                                <tr>
                                            ...
                                            <Table class="default-table table-unbordered table table-sm table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Model:</td>
                                                        <td>
                                                            {{ $solarList->solarListWithCable->model }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <td>
                                        @if ($solarList->solarListWithCable->image)
                                            <img src={{ URL::asset('brand/solar/solar_list/' . $solarList->solarListWithCable->image) }}
                                ...
                                <tr>
                                    <td colSpan='2'>
                                        <div class='solar-diameter'>
                                            @if ($solarList->solarListWithCable->diameter)
                                                <img src={{ URL::asset('brand/solar/solar_list/diameter/' . $solarList->solarListWithCable->diameter) }}
                        ...
                        <td class="report-content-cell">
                            <table style='width:100%;' class="inside-table-pump">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($inverter->image)
                                            <img src={{ URL::asset('brand/invertor/invertor_list/' . $inverter->image) }}
                                ...
                                <tr>
                                    <td colSpan='2' style='text-align: center;' class='controller-diameter'>
                                        @if ($inverter->diameter)
                                            <img src={{ URL::asset('brand/invertor/invertor_list/diameter/' . $inverter->diameter) }}
                            ...
                            <table style='width:100%;' class="inside-table-pump">
                                ...
                                <tr>
                                    <td colSpan='2' style='text-align: center;'>
                                        <img src={{ URL::asset('structure/' . $structure->image) }}
                            ...
                            <table style='width:100%;' class="inside-table-pump">
                                ...
                                <tr>
                                    <td style='text-align:center;'>
                                        @if ($solarList->image)
                                            <img src={{ URL::asset('brand/solar/solar_list/config/' . $solarList->image) }}
